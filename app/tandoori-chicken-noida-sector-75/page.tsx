...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://mkstandoori.com/tandoori-chicken-noida-sector-75' },
  openGraph: {
...
export default function TandooriChickenPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Tandoori Chicken Noida Sector 75', item: 'https://mkstandoori.com/tandoori-chicken-noida-sector-75' },
    ],
  }
