...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://mkstandoori.com/family-restaurant-sector-75-noida' },
  openGraph: {
...
export default function FamilyRestaurantPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Family Restaurant Sector 75 Noida', item: 'https://mkstandoori.com/family-restaurant-sector-75-noida' },
    ],
  }
