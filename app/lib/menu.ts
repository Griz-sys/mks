...
export type MenuItem = { name: string; nameHindi?: string; desc: string; prices: PriceOption[] }
...
export const MENU: MenuCategory[] = [
  {
    ...
    items: [
      { name: 'Classic Chicken', nameHindi: 'क्लासिक चिकन', desc: 'Overnight marinade, clay tandoor', prices: [
        { label: '2 Pc', price: '₹180' }, { label: '4 Pc', price: '₹350' }, { label: '8 Pc', price: '₹650' },
      ] },
      { name: 'Creamy Chicken', nameHindi: 'क्रीमी चिकन', desc: 'Rich cream marinade, clay tandoor', prices: [
        { label: '2 Pc', price: '₹190' }, { label: '4 Pc', price: '₹380' }, { label: '8 Pc', price: '₹680' },
      ] },
      { name: 'Classic Chicken Tikka', nameHindi: 'क्लासिक टिक्का', desc: 'Boneless, classic spice blend', prices: [
        { label: '4 Pc', price: '₹350' }, { label: '8 Pc', price: '₹650' },
      ] },
      { name: 'Creamy Chicken Tikka', nameHindi: 'क्रीमी टिक्का', desc: 'Boneless, cream & cashew marinade', prices: [
        { label: '4 Pc', price: '₹350' }, { label: '8 Pc', price: '₹650' },
      ] },
  ...
  },
  {
    ...
    items: [
      { name: 'Classic Soya Chaap', nameHindi: 'क्लासिक चाप', desc: 'Classic spice marinade, tandoor', prices: [{ label: '3 strips', price: '₹250' }] },
      { name: 'Creamy Soya Chaap', nameHindi: 'क्रीमी चाप', desc: 'Cream marinade, tandoor roasted', prices: [{ label: '3 strips', price: '₹250' }] },
      { name: 'Pickled Soya Chaap', nameHindi: 'अचारी चाप', desc: 'Achari marinade, tandoor roasted', prices: [{ label: '3 strips', price: '₹250' }] },
    ],
  },
  {
    id: 'rolls',
    ...
    items: [
      { name: 'Classic Chicken Roll', nameHindi: 'चिकन रोल', desc: 'Tandoori chicken, rumali, chutney', prices: [{ label: '', price: '₹180' }] },
