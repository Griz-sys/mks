...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.mkstandoori.in/chicken-biryani-noida' },
  openGraph: {
    title: "Chicken Biryani in Noida — MK's Restaurant Sector 75",
...
export default function ChickenBiryaniPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Chicken Biryani Noida', item: 'https://www.mkstandoori.in/chicken-biryani-noida' },
    ],
  }
